            ...
            >
              ...
              {harvest && (
                <div style={{marginTop: '5px', textAlign: 'center'}}>
                  <div style={{fontSize: '20px', color: 'var(--leaf)', marginBottom: '4px'}}>
                    {getProduceIcon(harvest.icon || harvest.produce, 20)}
                  </div>
        ...
        <div className="box-body" style={{padding: '0'}}>
          {harvests.map((h: any) => (
            <div key={h.id} style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '15px', borderBottom: '1px solid #eee'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: '15px'}}>
                <div style={{fontSize: '24px', color: 'var(--leaf)'}}>
                  {getProduceIcon(h.icon || h.produce, 24)}
                </div>
                <div>
