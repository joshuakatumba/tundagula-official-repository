...
import { updateHarvest } from '../../app/actions';
    ...
    <>
      ...
      {orders.length > 0 && orders[0].status === 'New' && (
        <div className="alert-banner">
          <span className="alert-icon" style={{display: 'flex', alignItems: 'center'}}><Package size={18} /></span>
          <div><strong>New order from {orders[0].customer}</strong> — {orders[0].quantity} {orders[0].produce} requested for {orders[0].delivery_date}. <Link href="/orders" style={{color:'var(--leaf)', fontWeight:'700'}}>Review & Accept →</Link></div>
      ...
      <div className="two-col">
        ...
        <div className="box">
          <div className="box-header">
            ...
            <Link href="/orders" className="box-link">View all</Link>
          </div>
          <div className="box-body" style={{paddingTop:'8px'}}>
            {orders.slice(0, 5).map((order: any) => (
              <div key={order.id} className="order-row">
                <div className="order-avatar">{getProduceIcon(order.icon || order.produce)}</div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="quick-actions">
                <Link href="/listings" className="qa-btn">
                ...
                <Link href="/momo" className="qa-btn">
      ...
      <div className="box">
        <div className="box-header">
          ...
          <Link href="/calendar" className="box-link">Manage Calendar</Link>
        </div>
        <div className="box-body" style={{display:'grid',gridTemplateColumns:'repeat(auto-fill, minmax(220px,1fr))',gap:'0 24px',paddingTop:'8px'}}>
          {harvests.map((h: any) => (
            <div key={h.id} className="cal-row">
              ...
              <div>
                <div className="cal-produce">{getProduceIcon(h.icon || h.produce)} {h.produce}</div>
